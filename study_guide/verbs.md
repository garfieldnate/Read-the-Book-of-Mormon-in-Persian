...
| | Singular | Plural |
|---|---|---|
| 1st | رفتم // _raftam_ // I went | رفتیم // _raftim_ // we went |
...
| | Singular | Plural |
|---|---|---|
| 1st | می‌روم // _mi-ravam_ // I go | می‌رویم // _mi-ravim_ // we go |
...
| | Singular | Plural |
|---|---|---|
| 1st | داشتم می‌رفتم // _dāshtam mi-raftam_ // I was going | داشتیم می‌رفتیم // _dāshtim mi-raftim_ // we were going |
...
| | Singular | Plural |
|---|---|---|
| 1st | رفته بودم // _rafte budam_ // I had gone | رفته بودیم // _rafte budim_ // we had gone |
...
| | Singular | Plural |
|---|---|---|
| 1st | بروم // _beravam_ // that I go | برویم // _beravim_ // that we go |
...
| | Singular | Plural |
|---|---|---|
| Affirmative | برو // _bero_ // Go! | بروید // _beravid_ // Go! (pl.) |
| Negative | نرو // _naro_ // Don't go! | نروید // _naravid_ // Don't go! (pl.) |
...
Most Persian verbs follow the رفتن pattern once you know the two stems. A handful of very common verbs have **structural** irregularities — where the paradigm itself departs from the expected pattern — in addition to the normal requirement to memorize the present stem. The rest are **stem-only** irregularities: unusual-looking present stems, but the paradigm is otherwise fully regular.
...
| `گفتن` (_goftan_) | to say | `گفت–` (_goft–_) | `گو–` (_gu–_) | Stem only |
| `آمدن` (_āmadan_) | to come | `آمد–` (_āmad–_) | `آ–` (_ā–_) | Stem + the imperative is `بیا`! (_biyā!_), not the expected form from the bare stem |
